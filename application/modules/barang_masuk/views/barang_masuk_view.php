                        ...
                        <div class="modal-body">
                              <form method="post" id="user_form" enctype="multipart/form-data">   
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="trans_in" id="trans_in" class="form-control" placeholder="Jumlah Masuk" />
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <div class="form-line">
   ...
   <script type="text/javascript"> 
    ...
    function CariBarang(){
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('barang_masuk/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){ 
		 var formData = new FormData($('#user_form')[0]);  
                 $.ajax({
                 url:"<?php echo base_url(); ?>barang_masuk/simpan_data",
                 type:"POST",
                 data:formData,
                 contentType:false,  
                 processData:false,   
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable({ 
			"ajax": "<?php echo base_url(); ?>barang_masuk/fetch_barang_masuk",  
		});

...
class M_report_keluar extends Parent_Model { 
  ...
  public function fetch_report_keluar(){
      
       $getdata = $this->db->get('m_report_keluar')->result();
       $data = array();  
           ...
           {  
                ...
                $sub_array[] = $row->nama_report_keluar;   

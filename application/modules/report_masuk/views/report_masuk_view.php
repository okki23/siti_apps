            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                                <form action="<?php echo base_url('report_masuk/print'); ?>" method="POST" target="_blank">
                                    ...
                                    <button type="submit" class="btn btn-primary"> <i class="material-icons">print</i> Generate Report Masuk </button>
                                </form>

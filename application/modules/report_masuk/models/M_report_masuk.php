...
class M_report_masuk extends Parent_Model { 
  
 
     var $nama_tabel = 'm_report_masuk';
     var $daftar_field = array('id','nama_report_masuk');
     var $primary_key = 'id';
  ...
  public function fetch_report_masuk(){
      
       $getdata = $this->db->get('m_report_masuk')->result();
       $data = array();  
           ...
           {  
                ...
                $sub_array[] = $row->nama_report_masuk;   
